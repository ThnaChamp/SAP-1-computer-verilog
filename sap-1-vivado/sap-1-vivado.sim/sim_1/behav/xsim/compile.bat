...
REM
REM Generated by Vivado on Sun May 17 19:16:55 +0700 2026
...
echo "xvlog --incr --relax -prj sap1_top_tb_vlog.prj"
call xvlog  --incr --relax -prj sap1_top_tb_vlog.prj -log xvlog.log
